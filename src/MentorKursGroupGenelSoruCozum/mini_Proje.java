...
public class mini_Proje {
     ...
     *      (Burasý ilk oyunun ilk if kýsmý-else kýsmý 3. adýmýn son sçeneði)
     *     *2. oyuncu Eger kelimeyi kabul ederse  1.oyuncuya kelimedeki harf sayisi kadar puan ekleyin
     *        ve 3.adima gecin
     *      * 2. oyunucu (oyunun devam etmesine baðlý olarak burasý 1 oyuncu tarafýndan da seçenek olacaktýr)
     *      girilen kelimeyi kabul etmezse "gecersiz kelime" yazdirin ve hangi  oyuncunun
     *        kazandigini yazip oyunu bitirin.
     *
     * 3.Adým- (oyunun devam etmesine baðlý olarak burasý 1 oyuncu tarafýndan da seçenek olacaktýr)
     *      2. oyuncuya oyuna devam etmek isteyip istemedigini sorun(devam etmek istemezse 3. adýmýn son þýkkýna gidecek)
     ...
     *
     *      * Devam etmek istemezse-ilk oyunda 2.oyuncu devrede(Burasý 2. adýmýn else kýsmý, oyunun devam etmesine baðlý olarak burasý 1 oyuncu tarafýndan da seçenek olabilir)
     *          "Oyun bitti" yazin
    ...
    public static void onaySor() {
        ...
        if (kabul == 1) {// 1 tercihi girilen kelimeyi kabul ediyor demektir
            ...
            else puan2 += kelime.length();//puaný 2. oyuncuya kelime harf saysý kadar ekledik.
            oyunaDevamEdecekMi();
        } else System.out.println("Oyuna Devam Etmek Ýstemiyorsunuz");
