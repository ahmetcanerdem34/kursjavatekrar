...
public class SetlerSoru_05 {

	/*
	 * main islemleri 1. 30 elemanli, elemanlari 0-10 arasinda sayilardan olusan bir
	 * arraylist olusturun 2. ekrana yazdirin 3. bu arrayin tekrar eden elemanlarini
	 * arrayden silen methodu yazin 4. sonucu ekrana yazdirin 5. Basta hazirlanan
	 * arraylist'i Set'e cevirin 6. Hazirlanan bu Set'i de Arraylist'e cevirin 7.
	 * Hem Set hem de ArrayList'e method ile hazirlanacak olan 20 elemanli,
	 * elemanlari 0-10 arasinda HuseyinBYCalısma.random sayilardan olusan
	 * arraylist'i ekleyin 8. Sonuc Set ve ArrayList'i yazdirin 9. Set icinde cift
	 * olan elemanlari iterator kullanarara silin
	 * 
	 */
