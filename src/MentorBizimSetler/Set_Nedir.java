...
public class Set_Nedir {
	...
	public static void main(String[] args) {
        ...
        Set : 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mükerrer eleman olmaz.
              2) sadece bir null deðeri alabilir.(treeSet hariç).Java elementleri unique yapmak icin HASH ALGORITMASI kullanir.
              Java her data icin hashing teknigini kullanarak bir code uretir.Bu code'u almak icin HashCode() methodu kullanilir.
              Hashing, farklý büyüklükteki girdilerden sabit büyüklükte bir çýktý oluþturma sürecine verilen isimdir.
         ...
         Set     --> HashSet         : 1) HashSet, duplication’a(tekrarlý eleman) izin vermez.
                                         Eger bir elemani tekrar HashSet’e eklemek isterseniz eski olan silinip, yeni olan uzerine yazilir.
                                       2) Haset'ler Set'ler arasinda en hizli olanýdir. bir algoritmaya göre kayit eder.
                                        deðerlerin giriþ sýrasýna dikkat edilmez. (LinkedHashSet hariç)
                     ...
                     TreeSet         : 1) TreeSet tekrarli eleman kabul etmez, cunku Set'dir.
		                                  2) Elemanlari natural Order'a(String ise alfabetik, sayi ise kucukten buyuge) gore dizer.
		 	                              3) TreeSet, setlerin en yavasidir. Bu yuzden TreeSet kullanirken dikkatli olunmalý...
      ...
      Set Methods :
         ...
         .retainAll(collection1);-->collection1’nin elemanlarinin disindaki tum elemanlari siler, silme islemi yapti ise true, yoksa false dondurur(kesiþen ortak elemanlarý döndürür.)
